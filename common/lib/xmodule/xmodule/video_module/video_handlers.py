...
class VideoStudentViewHandlers(object):
    ...
    def get_static_transcript(self, request, language):
        """
    ...
    def transcript(self, request, dispatch):
        ...
        if dispatch.startswith('translation'):
            ...
            try:
                ...
                response = self.get_static_transcript(request, language)
            else:
            ...
            try:
                ...
                return self.get_static_transcript(request, language)
            else:
                response = Response(
                    transcript_content,
                    headerlist=[
